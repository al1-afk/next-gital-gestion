...
const I18N = {
  fr: {
    signin:        'Se connecter',
    badge:         'Tarifs adaptés au Maroc — annulable à tout moment',
    ...
    formCta:       'Commencer',
    formFoot:      'Annulable à tout moment',
    statsCo:       'Entreprises',
    statsFac:      'Factures',
    ...
    finalFoot:     'Sans engagement · Annulable à tout moment',
    footer:        '© 2026 GestiQ — Tous droits réservés',
  },
  ar: {
    signin:        'تسجيل الدخول',
    badge:         'أسعار مناسبة للمغرب — يمكن الإلغاء في أي وقت',
    ...
    formCta:       'ابدأ الآن',
    formFoot:      'يمكن الإلغاء في أي وقت',
    statsCo:       'مقاولة',
    statsFac:      'فاتورة',
    ...
    finalCta:      'ابدأ الآن',
    finalFoot:     'بدون التزام · يمكن الإلغاء في أي وقت',
...
const PRICING_PLANS = [
  {
    key:        'essentiel',
    fr:         { name: 'Essentiel', price: '149', tag: 'Idéal pour commencer' },
    ar:         { name: 'أساسي',     price: '149', tag: 'مثالي للبداية' },
    highlight:  false,
    icon:       Sparkles,
