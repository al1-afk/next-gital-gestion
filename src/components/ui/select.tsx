...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'bg-[var(--surface-input)] px-3 py-2 text-sm text-foreground',
      'transition-all duration-150',
      'focus:outline-none focus:border-[#378ADD] focus:shadow-[0_0_0_3px_rgba(55,138,221,0.15)]',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'text-popover-foreground focus:bg-primary/15 focus:text-primary',
